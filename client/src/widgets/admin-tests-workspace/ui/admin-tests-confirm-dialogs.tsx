...
/**
 * Удалить навсегда можно только неиспользованный тест: без опубликованной версии, ссылок и
 * прохождений. Прежний текст обещал удалить и опубликованные версии, хотя сервер такое запрещает.
 */
const getDeleteTopicDescription = (topic: TestTopicListItem | null) =>
  topic
    ? `Тест "${topic.draftTitle}" будет удален без возможности восстановления. У него нет публикаций, ссылок и прохождений, поэтому ничего больше не пострадает.`
    : 'Тест будет удален без возможности восстановления.';
