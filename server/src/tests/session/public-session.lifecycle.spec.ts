...
import { createPublicSessionHarness } from '../session/public-session.spec-harness';

import type { PublicSessionHarness } from '../session/public-session.spec-harness';

jest.mock('../session/attempt-access', () => ({
